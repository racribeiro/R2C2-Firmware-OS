...
void fsdata_init()
{
  file_img_sics_gif.next = NULL;
  file_img_sics_gif.name = (unsigned char *)data_img_sics_gif;
  file_img_sics_gif.data = (unsigned char *)(data_img_sics_gif + 14);
  file_img_sics_gif.len = sizeof(data_img_sics_gif) - 14;

  file_404_html.next = &file_img_sics_gif;
  file_404_html.name = (unsigned char *)data_404_html;
  file_404_html.data = (unsigned char *)(data_404_html + 10);
  file_404_html.len = sizeof(data_404_html) - 10;

  file_index_html.next = &file_404_html;
  file_index_html.name = (unsigned char *)data_index_html;
  file_index_html.data = (unsigned char *)(data_index_html + 12);
  file_index_html.len = sizeof(data_index_html) - 12;
}
